      ...
      <section className="text-center sm:pt-16 pt-24 tab:pb-8">
        ...
        <div className="sm:p-8 ipad:px-16">
          ...
          <div className="lg:mb-8 sm:mb-4 ipad:mb-6 md:mb-8">
            <button className="bg-darkGreen lg:px-8 lg:py-3 mr-4 rounded-2xl text-white font-medium lg:text-lg text-md  mb-5 px-4 py-3 ipad:text-lg transition-all duration-300 ease-in-out hover:scale-105">
              <a href="#contact"> Contact Us</a>
            </button>
            <button className="bg-lightGreen lg:px-8   rounded-2xl text-white font-medium lg:text-lg text-md  px-4 py-3 mb-5 ipad:text-lg transition-all duration-300 ease-in-out hover:scale-105">
