    ...
    <Transition>
      <section className="text-center sm:pt-16 pt-24 tab:pb-8  ">
        ...
        <div className=" ipad:px-16 sm:px-6">
          <h1 className="desktop:text-6xl lg:text-5xl text-3xl text-darkGreen mt-20 sm:mt-16 mb-8 font-semibold ipad:text-4xl sm:text-pretty">
          ...
          <div className=" flex justify-center lg:mb-8 sm:mb-4 ipad:mb-6 md:mb-8">
            <div>
              <button
                onClick={goToContact}
                className="bg-darkGreen lg:px-5 lg:py-3 mr-4 rounded-2xl text-white font-medium lg:text-lg text-md  mb-5 px-4 py-3 ipad:text-lg transition-all duration-300 ease-in-out hover:scale-105 w-[150px]"
              >
                Contact Us
              </button>
            </div>
