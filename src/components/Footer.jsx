...
const Footer = () => {
  return (
    <footer className="bg-lightGreen text-white lg:px-32 lg:py-8 text-lg font-semibold p-6">
      <div className="grid grid-cols-5 md:gap-8 lg:gap-6">
        ...
        <div className="sm:col-span-2 lg:col-span-1 lg:ml-8">
        ...
        <div className="sm:col-span-2 lg:ml-2">
        ...
        <div className="sm:col-span-4 md:col-span-2 lg:col-span-2 lg:ml-10">
