...
const About = () => {
  return (
    <section className="lg:px-32 lg:py-24 lg:my-4 tab:my-4 aboutBackground-image px-8 sm:mt-20 py-16 ipad:px-16">
      ...
      <div className="lg:grid lg:grid-cols-2 ipad:grid ipad:grid-cols-2 items-center ipad:gap-6 tab:gap-0">
        <div>
          <img
            className="lg:w-4/5 sm:m-auto lg:rounded-xl sm:mb-8 sm:w-[24rem] rounded sm:w-4/5 tab:w-4/5"
