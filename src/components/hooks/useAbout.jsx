const useAbout = () => {
  const aboutContent = [
    ...
    {
      description: [
        "Integrity: Upholding the highest ethical standards with transparency, honesty, and trust.",

        "Innovation: Constantly seeking new ways to solve complex problems and push technological boundaries.",

        "Client-Centric: Putting clients at the heart of everything we do, delivering tailored solutions to their unique needs.",

        "Collaboration: Fostering a culture of teamwork, creativity, and shared success for the best results.",
