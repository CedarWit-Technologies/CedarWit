...
const Services = () => {
  ...
  return (
    <Transition>
      <div className="bg-lightGreen lg:px-32 py-20 flex flex-col gap-12 lg:justify-between items-center text-3xl font-semibold text-white tab:px-16 sm:px-6 md:px-12 ipad:px-12">
        Services We Provide
