...
const Services = () => {
  ...
  return (
    <Transition>
      <div id="services" className="bg-lightGreen lg:px-32 ipad:px-10 sm:px-6 py-20 flex flex-col gap-12 justify-center items-center text-3xl font-semibold text-white tab:px-16">
        Services We Provide
